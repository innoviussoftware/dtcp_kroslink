  ...
  <div class="row">
    ...
    <div class="col-md-8 col-xs-8">
      ...
      <div class="box">
        ...
        <form action="{{route('admin.submenu.storemenu')}}" method="post">
        ...
        <div class="box-header">
          ...
          <h3 class="box-title">Add Sub Menu</h3>
        ...
        <div class="box-body">
          ...
          <div class="form-group">
                ...
                <label>Menu</label>
                  ...
                  <select class="form-control" name="menu" id="area" required>

                    <option value="">Select Menu</option>
                    @foreach($menu as $menu)
                    <option class="form-control" value="{{$menu->id}}">{{$menu->name}}</option>
                    @endforeach
