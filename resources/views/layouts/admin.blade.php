...
<style type="text/css">
  .content-headers .cu-head{
      display: inline-block;
      padding: 10px 0px;
  }
  .cu-head .adminslogan .name{
    font-size: 36px;
    font-weight: 500;
    line-height: 40px;
    color: #073747;
  }
  .cu-head .adminslogan .desc{
    font-size: 26px;
    line-height: 32px;
    color: #c73c27;
    margin-top: 10px;
...
<div class="content-headers">
    <div class="cu-head">
            <div class="col-md-1">
              <a href="#"><img width="100%" src="{{asset('/public/front_end/newimages/logo.png') }}"></a>
            </div>
            <div class="col-md-10 text-center">
              <div class="adminslogan">
                  <div class="name">Directorate of Town and Country Planning</div>
                  <div class="desc hidden-xs">நகர் ஊரமைப்பு இயக்ககம்</div>
              </div>
            </div>
            <div class="col-md-1">
              <a href="#"><img width="100%" src="{{asset('/public/front_end/newimages/DTCP.png') }}"></a>
            </div>
          </div>
    </div>
</div>
